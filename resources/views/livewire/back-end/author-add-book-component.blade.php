                    ...
                    <div class="col-md-8 my-5 p-5  rounded-3" style="background-color: #FFFFFF">
                        ...
                        <form wire:submit.prevent="addBook" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="book_description" rows="3" wire:model="book_description"></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="book_index_file" name="book_index_file"
                                    wire:model="book_index_file">
                                @error('book_index_file')
                                <span class="error" style="color: red">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="book_demo_vedio" name="book_demo_vedio"
                                    wire:model="book_demo_vedio">
                                @error('book_demo_vedio')
                                <span class="error" style="color: red">{{$message}}</span>
                                @enderror
                            </div>
